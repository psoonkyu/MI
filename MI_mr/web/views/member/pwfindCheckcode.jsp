...
<body>
	...
	<script>
		...
		//인증하기 버튼
		function codesuc(){
			opener.document.pwFindFrm.mailcode_btn.style.display="none";
			opener.document.pwFindFrm.mailcodeEnd_span.style.display="inline-block";
			opener.document.pwFindFrm.pwEmail.readOnly = true;
			window.close();
		}
	</script>
</body>
